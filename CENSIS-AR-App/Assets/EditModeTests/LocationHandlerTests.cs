...
public class LocationHandlerTests
{
    ...
    public void testIsFinalLocationWhenIsNot()
    {
        ...
        Location loc1 = new Location("testLocation", "clue text", "information", new float[] { 55.87394f, -4.29181f }, new float[][][]{ new float[][]{
        ...
        Location loc2 = new Location("testLocation2", "clue text2", "information2", new float[] { 55.87394f, -4.29181f }, new float[][][]{ new float[][]{
        new float[] {55.6829478f,-4.5160826f },
        new float[] {55.6830784f, -4.5155368f},
        new float[] {55.6827737f, -4.5153076f },
        new float[] {55.6826432f, -4.5158534f },
